...
public class Scanner {
	...
	static {
		...
		literals.put("final", new Integer(9));
		literals.put("class", new Integer(13));
		literals.put("if", new Integer(16));
		literals.put("else", new Integer(17));
		literals.put("while", new Integer(18));
		literals.put("return", new Integer(19));
		literals.put("read", new Integer(20));
		literals.put("print", new Integer(21));
		literals.put("new", new Integer(29));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 2:
					...
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); state = 2; break;}
					else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 3:
					if (ch <= 8 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= 65535) {AddCh(); state = 4; break;}
					else {state = 0; break;}
				case 4:
